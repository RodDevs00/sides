    ...
    <div class="navbar-wrapper">
        <div class="navbar-brand header-logo">
            <a href="{{ route('dashboard') }}" class="b-brand">
                <img class="if-logo-img" src="{{ asset('img/landing/balais.jpg') }}">
            ...
            <ul class="nav pcoded-inner-navbar">
                ...
                @if ($user->type === 'admin')
                    ...
                    <li data-username="Admins" class="nav-item @yield('sidebar_admins')">
                        <a href="{{ route('admins.index') }}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-lock"></i></span><span class="pcoded-mtext">Admins</span></a>
                    </li>
                @endif
