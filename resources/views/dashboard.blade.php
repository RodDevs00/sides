                                ...
                                <div class="col-md-4 col-xl-4">
                                    <div class="card shadow-sm">
                                        <div class="card-block customer-visitor">
                                            ...
                                            <span class="text-right d-block h5">Scheduled</span>
                                                ...
                                                @if ($appointments->isNotEmpty())
                                                    <div class="table-responsive">
                                                        <table class="table table-hover">
                                                            <thead>
                                                                <tr>
                                                                    <th colspan="2">{{ $user->type === 'patient' ? 'Doctor' : 'Patient' }}</th>
                                                                    <th>Date</th>
                                                                    <th>Status</th>
                                            ...
                                            <div class="card-block pb-0">
                                                ...
                                                @if ($user->type === 'patient')
                                                    <a href="{{ route('appointments.index') }}" class="btn btn-outline-primary" style="width: 100%; margin-bottom: 20px;">
                                                        <i class="feather icon-plus-circle"></i>Schedule Appointment
                                                    </a>
                                                @endif
                                            </div>
                                        </div>
